              ...
              if (snapshot.hasData) {
                return Padding(
                  ...
                  child: PaginatedDataTable(
                    ...
                    source: DataSource(context, snapshot.data!.docs),
                    actions: [
                      Padding(
                        padding:
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 24),
                  Center(
                      child: Text("Add New region Details",
                          style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                              color: Colors.black87))),
                  SizedBox(height: 12),
                  Center(child: _textField(_cityController, 'City Name')),
                  SizedBox(height: 8),
                  Center(child: _textField(_regionController, 'Enter Region')),
                  SizedBox(height: 8),
                  Center(
                  ...
                  Center(
                      child: _textField(
                          _deliveryChargeController, 'enter Delivery Charge')),
                  SizedBox(height: 12),
                  Center(
                    child: Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (_cityController.text != null &&
                              ...
                              _deliveryChargeController.text != null) {
                            _addRegion();
                          } else {
                            Navigator.pop(context);
                          }
        ...
        DataCell(IconButton(
          ...
          onPressed: () async {
            CollectionReference reference =
                FirebaseFirestore.instance.collection('Regions');
            try {
              await reference.doc(row.id).delete();
            } catch (e) {}
          },
        )),
      ],

...
class _RegistrationEmployeeState extends State<RegistrationEmployee> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: _form(
                            'Driving Licence*', 'licence no', deliveryLicence),
                      ),
                      Expanded(
                        child: _form('Adhar Number*', 'number', adharNumber),
                      ),
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: _form('Vehicle No*', 'no', registrationNO),
                      ),
                      Expanded(
                        child: Container(),
                      ),
  ...
  Future _create() async {
    ...
    try {
      var v = await auth.createUserWithEmailAndPassword(
          email: email.text.trim(), password: phone.text.trim());
      if (v != null) {
        _upload(v.user!);
      }
    } catch (e) {

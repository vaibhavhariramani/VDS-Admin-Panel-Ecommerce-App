...
class BulkProductEditor extends GetResponsiveView<ProductsListingController> {
  Product ProductDetails;
  int index;
  BulkProductEditor(
      {required this.ProductDetails, required this.index, Key? key})
      : super(key: key);
  ProductsListingController productController =

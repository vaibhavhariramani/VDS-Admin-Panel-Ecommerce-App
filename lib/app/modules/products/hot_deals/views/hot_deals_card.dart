...
import 'hot_deal_edit_dialog.dart';

class HotDealProductCard extends GetResponsiveView<HotDealsController> {
  ...
  @override
  HotDealsController controller = Get.put(HotDealsController());
  HotDealProductCard({
    Key? key,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                RichText(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: DataService.to
                            .DateTimeToString(date: productItem.expires_on!),
                        style: DefaultTextStyle.of(context).style.copyWith(
                              fontSize: 14,
                            ),
                      ),
                ...
                //     children: [
                //       TextSpan(
                //         text: EnumToString.convertToString(productItem.deal_type),
                //         style: DefaultTextStyle.of(context).style.copyWith(
                //               fontSize: 12,
                //               color: Theme.of(context).disabledColor,
                //             ),
                        ...
                        content: Column(
                          children: [
                            ...
                            SizedBox(
                              width: 200,
                              child: Text(
                                  "This product will be available on App from ${productItem.available_from?.toString().substring(0, 10)} to ${productItem.expires_on?.toString().substring(0, 10)}"),
                            ),
                          ],
                        ),
                      );
                ...
                await Get.dialog(
                  AlertDialog(
                    content: SizedBox(
                      ...
                      child: HotDeadProductEditor(ProductDetails: productItem),
                    ),
                  ),
                );
                Get.back();

...
class HotDeadProductEditor extends GetResponsiveView<HotDealsController> {
  Product ProductDetails;
  HotDeadProductEditor({required this.ProductDetails, Key? key})
      : super(key: key);
  HotDealsController productController = Get.put(HotDealsController());
  @override

...
class SchProductEditor extends GetResponsiveView<ScheduledProductsController> {
  Product ProductDetails;
  SchProductEditor({required this.ProductDetails, Key? key}) : super(key: key);
  ScheduledProductsController productController =
